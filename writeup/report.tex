...
% TODO compare actual action choices vs hand coded policy

\section{Did RL actually work?} We would be remiss if we did not evaluate the RL agents skeptically, as RL has been accused of many misdeeds. %TODO citation needed
...
Source code, data and figures for this paper can be accessed at. %TODO
